...
class _FirebaseDemoState extends State<FirebaseDemo> {
  ...
  //Collection of items for the firebase instance
  ...
  //Button used to logout the user from their specific list
  Widget logoutButton() {
  ...
  //Screen for the user to login, authentication is checked by calling the sign in with google method
  Widget loginScreen() {
    return Scaffold(
      body: Container(
        padding: EdgeInsets.symmetric(horizontal: 10, vertical: 50),
